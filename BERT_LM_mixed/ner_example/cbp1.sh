export OUTPUT_DIR=/data/s2071932/Transformers/resources/output/cbp_ner01_hg1_v2/
export BATCH_SIZE=8
...
python3 -u run_ner.py --data_dir /local/s2071932/general_data/cbp_gold_small_v2/1/ \
